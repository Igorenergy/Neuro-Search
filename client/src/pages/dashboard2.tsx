    ...
    <div className="max-w-[1600px] mx-auto space-y-6 font-sans">
        ...
        <div className="bg-[#EBEBEB] border border-gray-300 rounded-sm relative overflow-hidden">
          <div className="flex items-center justify-between p-3 border-b border-gray-200 bg-[#E0E0E0]">
            <div className="flex items-center gap-2">
              ...
              <h2 className="font-bold text-gray-800 text-sm">Our Latest News</h2>
            </div>
            <div className="flex items-center gap-2">
              <Button variant="outline" size="sm" className="h-6 text-xs border-gray-400 text-[#006E7D] bg-white hover:bg-gray-50">See all</Button>
              <Button variant="ghost" size="icon" className="h-6 w-6 text-[#006E7D] hover:bg-transparent" onClick={() => setShowBanner(false)}>
          ...
          <div className="p-4 grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-2 bg-[#EBEBEB]">
             <div>
               <a href="#" className="block text-sm font-medium text-gray-800 hover:underline decoration-gray-400 underline-offset-2 mb-0.5">
                 Introducing research models with Basis for the Parallel Chat API
               </a>
               <p className="text-[10px] text-gray-500 font-bold uppercase tracking-wide">PRODUCT UPDATE • 4 DAYS AGO</p>
             </div>
             <div>
               <a href="#" className="block text-sm font-medium text-gray-800 hover:underline decoration-gray-400 underline-offset-2 mb-0.5">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button variant="outline" className="h-8 bg-white border-gray-300 text-sm font-normal min-w-[100px] justify-between">
            All: 20
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-6 flex flex-col items-center justify-center text-center shadow-sm hover:shadow-md transition-shadow min-h-[220px]">
          ...
          <h3 className="text-lg font-bold text-gray-900 mb-4">Create research</h3>
          <div className="space-y-2 w-full">
            <Link href="/smart-search/new">
              <a className="block text-sm font-bold text-[#008DA8] hover:underline mb-2">SMART SEARCH</a>
            </Link>
            <Link href="#">
              <a className="block text-sm font-bold text-[#008DA8] hover:underline">SMART SHEET</a>
            </Link>
          </div>
        </div>
        ...
        {/* Project Cards */}
        {searches.map((item) => (
          <div key={item.id} className={cn("rounded-xl p-5 relative group flex flex-col min-h-[220px] transition-all hover:shadow-md", item.color)}>
            <div className="flex justify-between items-start mb-4">
              <div className={cn("w-12 h-12 rounded-lg flex items-center justify-center border-2 border-black/5", item.iconBg)}>
                 <item.icon className={cn("w-7 h-7 stroke-[1.5]", item.iconColor)} />
              </div>
              <div className="flex items-center gap-1">
                {item.hasAttachment && (
                  <Button variant="ghost" size="icon" className="h-8 w-8 text-gray-500 hover:bg-black/5 rounded-full">
